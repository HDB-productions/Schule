      ...
      <section class="panel stack-gap overview-view">
        ...
        <div class="overview-grid">
          ...
          <article class="subpanel">
            ...
            <table class="simple-table">
              <thead><tr><th>Schüler</th><th>Punkte</th><th>Bonus</th><th>Prozent</th><th>Note</th></tr></thead>
              <tbody>
          ...
          <tbody>
            ${students.map(function (student, index) {
              return `<tr>
                ...
                <td>
                  <div class="inline-actions wrap-actions">
                    <button type="button" class="secondary-button tiny-button" data-action="move-student" data-student-id="${student.id}" data-direction="-1">↑</button>
                    <button type="button" class="secondary-button tiny-button" data-action="move-student" data-student-id="${student.id}" data-direction="1">↓</button>
        ...
        <article class="subpanel stack-gap">
          <div class="panel-header">
            <div>
              ...
              <p class="muted-text">Format für Schnellanlage: Titel | Punkte</p>
            </div>
          </div>
          <div class="inline-form wrap-actions">
              ...
              <article class="structure-row subpanel" draggable="true" data-node-id="${node.id}">
                <div class="structure-header" style="padding-left:${node.depth * 18}px">
                  ...
                  <div class="inline-actions wrap-actions">
                    ...
                    <button type="button" class="secondary-button tiny-button" data-action="move-node" data-node-id="${node.id}" data-direction="-1">↑</button>
                    <button type="button" class="secondary-button tiny-button" data-action="move-node" data-node-id="${node.id}" data-direction="1">↓</button>
    ...
    return `
      <section class="panel stack-gap print-panel">
        <div class="panel-header no-print">
          <div>
            <h2>Druckansicht</h2>
            <p class="muted-text">Formale Sammelausgabe für den Browserdruck.</p>
          </div>
            ...
            return pages.map(function (pageRows, pageIndex) {
              return `<section class="print-sheet-page">
                ...
                <footer class="print-sheet-footer">
                  <div><strong>Gesamt:</strong> ${totals.totalAchieved.toFixed(1)} / ${totals.maxRegular.toFixed(1)} Punkte | Bonus ${totals.bonusAchieved.toFixed(1)} | ${totals.percent.toFixed(2)}% | Note ${escapeHtml(totals.gradeLabel)} | Kürzel ${escapeHtml(exam.metadata.lehrkraftKuerzel || "_____")}</div>
