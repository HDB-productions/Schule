...
Ein Finger dreht den Tisch. Zwei Finger verschieben die Ansicht �ber die Bewegung ihres Mittelpunkts und zoomen gleichzeitig �ber ihren Abstand (OrbitControls DOLLY_PAN, bildschirmbezogenes Pan). Nach Mehrfinger-Gesten und Abbruch werden keine Anschluss-Klicks ausgel�st; ein neuer Tap funktioniert normal. Kameraposition und Ziel werden �ber den bestehenden Speicherweg in localStorage bzw. E1 erhalten. Keine zus�tzliche Begrenzung der Verschiebung; die vorhandenen Zoom- und Winkelgrenzen bleiben bestehen. `tests/dynamot-touch-pan.test.cjs` pr�ft echte Chromium-Multi-Touch-Ereignisse bei 1024�668 und 1180�720: Pan in beiden Achsen, kombiniertes Pinch/Pan, �bergang zu Einfinger-Orbit ohne Sprung, Abbruch, Seitenscroll, Tap und Kamera-Restore �ber beide Speicherwege. Eine Pr�fung auf physischer Tablet-Hardware steht aus.
