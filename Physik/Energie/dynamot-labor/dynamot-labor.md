...
Die Energieanzeige verwendet für alle Stationen eine gemeinsame schematische Zeitlupe: Ein angekommenes Paket schrumpft während seiner Umwandlung; die Ausgangspakete wachsen gleichzeitig und werden danach weitertransportiert. Die Fläche steht für die Energiemenge. Das gilt für Generatoren, Motoren, Lampen und Gewichte, einschließlich mehrerer Quellen und Verbraucher. Am Gewicht geht die grüne mechanisch übertragene Energie kontinuierlich in den lila Lageenergie-Vorrat über. Die Darstellung verzögert Energieübertragungen bewusst und verändert weder die physikalische Simulation noch Aufgaben oder Punkte.
...
Die neue reine Animationslogik liegt in `dynamot-energie-puffer.js`. Prüfung: `tests/dynamot-energie-puffer.test.cjs` für Transport/Umwandlung und Bilanz; `tests/dynamot-energie-browser.test.cjs` für die vier realen Versuchsaufbauten und die sichtbaren Größenänderungen; `tests/dynamot-gewicht-hoehe.test.cjs` für die Höhenbedienung. Die Verzögerungen sind keine zusätzlichen realen Energiespeicher im Gerät.
